...
if __name__ == "__main__":
    ...
    miqScoreShotgunPublicSupport.alignmentAnalysis.bwaHandler.bwaAlign(parameters.forwardReads.value, parameters.reverseReads.value, parameters.workingFolder.value, bamFilePath, parameters.referenceGenome.value)
    readTable = miqScoreShotgunPublicSupport.alignmentAnalysis.alignmentAnalysis.bamFileProcessor(bamFilePath)
